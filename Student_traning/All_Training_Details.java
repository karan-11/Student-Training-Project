...
public class All_Training_Details extends JFrame implements ActionListener {
    JPanel p1;
    JTable t;
    JLabel l;
    JButton b;
    ...
    String [] col={"Roll_no","Name","Course","Company","Start Date","Duration"};
    String [][] row;

    public All_Training_Details()
    {
        ...
        try
        {
            ...
            statement=connection.prepareStatement("select count(roll_no) from training_details");
            ...
            statement=connection.prepareStatement("select * from training_details");
            set=statement.executeQuery();
        ...
        l=new JLabel("Training Details Details");
        b=new JButton("Back");

        sp.setBounds(20,60,450,340);
    ...
    {
        All_Training_Details td = new All_Training_Details();
    }
